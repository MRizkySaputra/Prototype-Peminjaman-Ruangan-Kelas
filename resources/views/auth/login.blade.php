...
@section('content')
    ...
    <form action="/login-process" method="POST" class="space-y-5">
        ...
        {{-- Username --}}
        <div class="space-y-2">
            <label class="text-xs font-bold uppercase tracking-wider text-variant px-1">Nama Pengguna</label>
            <div class="relative">
                ...
                <input class="block w-full pl-12 pr-4 py-3 bg-[#e5e9eb] border-none rounded-lg text-sm focus:ring-2 focus:ring-[#002045]/20 outline-none"
                       name="username" type="text" placeholder="Masukkan nama pengguna" required>
            </div>
        </div>
        ...
        <div class="text-sm text-gray-600">
            Belum punya akun?
            <a href="/register" class="font-medium text-[#002045] hover:underline ml-1">Daftar sekarang</a>
        </div>
